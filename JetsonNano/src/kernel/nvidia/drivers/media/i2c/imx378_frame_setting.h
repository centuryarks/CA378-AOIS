...
#define IMX378_FARAME_H_4K3K                    (13125)
...
#define IMX378_DATA_RATE_VGA                    (250*6/1*2)     // Datarate(Mbps) for VGA
#define IMX378_PLL_MULTI_VIDEO                  (350)           // PLL multiplier for Internal Video Timing System Clock
#define IMX378_PLL_MULTI_4K3K                   (250)           // PLL multiplier for Internal Output Pixel System
#define IMX378_PLL_MULTI_4K2K                   (250)           // PLL multiplier for Internal Output Pixel System
#define IMX378_PLL_MULTI_FHD                    (250)           // PLL multiplier for Internal Output Pixel System
#define IMX378_PLL_MULTI_VGA                    (250)           // PLL multiplier for Internal Output Pixel System
#define IMX378_SYCK_DIV_4K3K                    (1)             // System Clock Divider
#define IMX378_SYCK_DIV_4K2K                    (1)             // System Clock Divider
#define IMX378_SYCK_DIV_FHD                     (1)             // System Clock Divider
#define IMX378_SYCK_DIV_VGA                     (1)             // System Clock Divider
