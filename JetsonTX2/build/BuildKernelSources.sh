...
echo -n "What is the number of framerate for 640x480 ? (240/200/150/120/60) : "
read ans
FPS_VGA=$ans
...
cp ./src/imx378_mode_tbls.h ./kernel/nvidia/drivers/media/i2c/imx378_mode_tbls.h
cp ./src/imx378_frame_setting.h ./kernel/nvidia/drivers/media/i2c/
