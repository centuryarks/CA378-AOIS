...
PLL_TBL_FHD=(238 196 154 238 196 154 246)
DIV_TBL_FHD=(  1   1   1   2   2   2   4)
FPS_TBL_FHD=(120  96  80  60  48  40  30)
NUM_FHD=${#FPS_TBL_FHD[@]}

PLL_TBL_VGA=(    165 165 210 275 165 210 245 275 330 343 350)
DIV_TBL_VGA=(      4   2   2   2   1   1   1   1   1   1   1)
FPS_TBL_VGA=(     60 120 150 200 240 300 350 400 480 500 512)
FRAME_V_TBL_VGA=(528 528 525 528 528 525 525 528 528 525 525)
NUM_VGA=${#FPS_TBL_VGA[@]}
...
PIX_CLK_4K3K=`expr ${PLL_4K3K} / ${DIV_4K3K} \* ${INCK} \* ${MIPI_LANE} / ${RAW_BIT}`
...
PIX_CLK_4K2K=`expr ${PLL_4K2K} / ${DIV_4K2K} \* ${INCK} \* ${MIPI_LANE} / ${RAW_BIT}`
...
PIX_CLK_FHD=`expr ${PLL_FHD} / ${DIV_FHD} \* ${INCK} \* ${MIPI_LANE} / ${RAW_BIT}`
...
PIX_CLK_VGA=`expr ${PLL_VGA} / ${DIV_VGA} \* ${INCK} \* ${MIPI_LANE} / ${RAW_BIT}`
